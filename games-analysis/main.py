...
plt.scatter(["first_release_date"], df_main["user_rating_value"], color = "red", label = "User Ratings")
...
df_main = pd.read.csv("game-ratings-by-top-10-genres.csv")
...
df_main = pd.read.csv("game-ratings-by-top-10-platforms.csv")
